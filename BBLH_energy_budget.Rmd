...
ggplot(m.bblh, aes(Site, value, fill=)) + geom_bar(stat="idenity", aes(col=variable)) + my_theme + scale_color_manual("Energy expenditure", labels=c("Nighttime", "24-hour daily"), values=c("#000080", "#ff0000")) + ylab("kilo Joules")
