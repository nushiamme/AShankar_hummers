...
dee_BBLH_site_monsoon <- ggplot(dlw_bblh, aes(Site_proxy, kJ_day)) + geom_boxplot() + my_theme + 
  geom_point(aes(shape=Pre_post_monsoon), size=5, alpha=0.4) + scale_shape_manual("Season\n", values=c(19,17)) + 
