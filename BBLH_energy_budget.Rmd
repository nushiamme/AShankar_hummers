...
## Create a column tha's a combindation of Site and monsoon status
dlw_bblh$Site_monsoon <- paste(dlw_bblh$Site, dlw_bblh$Pre_post_monsoon, sep="_")
...
dee_BBLH_monsoon <- ggplot(dlw_bblh, aes(Initial_mass_g, kJ_day)) + 
...
## DEE by site
dee_BBLH_site <- ggplot(dlw_bblh, aes(Initial_mass_g, kJ_day)) + 
