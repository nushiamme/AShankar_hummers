...
#This script uses annotates every minute of data with the metabolism state at that time.
...
TORPOR_smooth_state_func<-function(RUN_ID, SPAR_SMOOTHINT, ENTRY_CUTOFF,AROUSAL_CUTOFF){
  ...
  #     #where VO2 STABLE, and min elapsed is before the start of entry, as "NORMOPRE"
  #     RUN_ID$State[RUN_ID$Stability== "STABLE" & 
  #                   RUN_ID$Minute_Elapsed <= first(RUN_ID$Minute_Elapsed[RUN_ID$Stability=="DECREASING"])] <- "NORMOPRE" 
  ...
  #       
  #     #where VO2 stable, and min elapsed is AFTER the end of entry, and BEFORE the start of arousal, as TORPOR
  #     RUN_ID$State[RUN_ID$State== "STABLE" &
  #                   RUN_ID$Minute_Elapsed <= (first(RUN_ID$Minute_Elapsed[RUN_ID$State=="AROUSAL"])) &
  #                     RUN_ID$Minute_Elapsed >= (first(RUN_ID$Minute_Elapsed[RUN_ID$State=="ENTRY"]))] <- "TORPOR1" 
  #       
  #     RUN_ID$State[RUN_ID$State== "STABLE" &
  #                   RUN_ID$Minute_Elapsed > (last(RUN_ID$Minute_Elapsed[RUN_ID$State=="ENTRY"])) &
  #                     RUN_ID$Minute_Elapsed <= (last(RUN_ID$Minute_Elapsed[RUN_ID$State=="AROUSAL"]))] <- "TORPOR2" 
  #     
  #     RUN_ID$State[RUN_ID$State== "STABLE" &
  #                   RUN_ID$Minute_Elapsed > (first(RUN_ID$Minute_Elapsed[RUN_ID$State=="AROUSAL"])) &
  #                     RUN_ID$Minute_Elapsed <= (last(RUN_ID$Minute_Elapsed[RUN_ID$State=="ENTRY"]))] <- "NORMOMID" 
  #     
  #     RUN_ID$State[RUN_ID$State== "ENTRY" & 
  #                   RUN_ID$Minute_Elapsed <=first(RUN_ID$Minute_Elapsed[RUN_ID$State=="TORPOR1"])] <- "ENTRY1" 
  #       
  #     RUN_ID$State[RUN_ID$State== "ENTRY" & 
  #                   RUN_ID$Minute_Elapsed >=last(RUN_ID$Minute_Elapsed[RUN_ID$State=="TORPOR1"])] <- "ENTRY2" 
  #     RUN_ID$State[RUN_ID$State== "AROUSAL" & 
  #                   RUN_ID$Minute_Elapsed <=first(RUN_ID$Minute_Elapsed[RUN_ID$State=="TORPOR2"])] <- "AROUSAL1" 
  #       
  #     RUN_ID$State[RUN_ID$State== "AROUSAL" & 
  #                   RUN_ID$Minute_Elapsed >=last(RUN_ID$Minute_Elapsed[RUN_ID$State=="TORPOR2"])] <- "AROUSAL2"  
  # #this is still doesnt work
  #  }#END DOUBLE TORPOR
