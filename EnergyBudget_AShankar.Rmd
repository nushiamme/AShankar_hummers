...
Assuming that Broad-billed hummingbirds will fly at their most efficient speed (6-8m/s) and that the power curves for Ecuadorian hummingbirds are similar to those measured for other species, I can estimate FLMR for Broad-billed hummingbirds to be:
