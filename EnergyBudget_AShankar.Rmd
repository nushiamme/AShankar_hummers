...
Powers has measured hovering metabolic rates (HMR) in Broad-billed hummingbirds. Mean HMR~BBLH~ = 2.1 mL O~2~/min, with values ranging from 0.764 to 3.309 ml O~2~/min.
...
&nbsp;&nbsp;**A.  No torpor**  
Nighttime metabolic rate (NMR) will be BMR plus the cost of thermoregulation below the lower critical temperatures (i.e. TRE~L~).  Thus, NMR for normothermic hummingbirds can be calculated using equation 1a and nighttime temperature data. NMR calculated this way was verified to be the same as nighttime energy expenditure data from birds which did not use torpor at all.
