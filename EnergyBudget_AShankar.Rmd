...
**Figure 2**: Power curves from multiple species, from Warrick et al. 2012.

FLMR~Calliope~ = 0.53 x HMR

FLMR~Rufous~ = 0.49 x HMR

Given the mass of Broad-billed hummingbirds and their estimated pectoralis mass-specific power, I assume that Broad-billed hummingbirds will fly at their most efficient speed (6-8m/s). I can estimate FLMR for Broad-billed hummingbirds to be:
