...
## Total energy spent on BMR + thermoregulation in 24 hours
tre_total <- tre_h + tre_l + bmr

## Nighttime energy expenditure in ml O2/h
nee <- 218.9
...
## Total energy spent on daytime activities in ml O~2~/h. 
## Assuming ACT = 70% resting + 15% hovering + 15% flying; 14 daylight hours
ACT <- (0.7*14*(rmr-bmr)) + (0.15*14*(hmr-bmr)) + (0.15*14*(flmr-bmr))

## Model estimate in ml O~2~ in 24 hours
DEE_model <- ACT + nee + tre_total

## To get a per hour CO~2~ estimate, multiply by RQ (0.85) and divide by 24
