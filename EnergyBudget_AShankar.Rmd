...
----------------------------
There is a large amount of individual and daily variation in the frequency and duration of torpor use. For the sake of modeling DEE I assume that either torpor is not used at all, or if torpor is used it is used to the full extent observed.  By doing so I can create upper and lower energetic boundaries based on whether or not torpor was used.  
