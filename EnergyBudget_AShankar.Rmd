...
The model estimate is `r per.off`% lower than the measured value. I am encouraged by this considering that this model is likely biased low since costs of molt and reproduction are not specifically considered, and since the higher thermoregulatory slope is taken from a desert-adapted species.